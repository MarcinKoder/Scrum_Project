            ...
            <div class="dashboard-content border-dashed p-3 m-4 view-height">
                ...
                <table class="table border-bottom schedules-content">
                    ...
                    <tr class="d-flex">
                        ...
                        <td clas="col-7">Mamusina najlepsza zapiekanka pod słońcem. Można ją podać jako główne danie albo jako kolację. W zapiekance możesz użyć również kiełbasy paprykowej sprawi ona, że zapiekanka będzie ostrzejsza w smaku. Zgodnie z zalecanimi Makłowicza, podawać z dobrze dobranym winkiem ;)</td>
